...
class RLSNet(torch.nn.Module):
    def __init__(self, args, pretrained=True):
        ...
        self.road_linear_1 = nn.Linear(512 * 2 * 3, 256) if args.backbone in ['34','18'] else nn.Linear(2048 * 2 * 3, 1024)
        ...
        self.drivable_decoder = drivable_BUSD(img_height = 720, img_width = 1280, num_classes = args.road_classes)
