...
class RLSNet(torch.nn.Module):
    def __init__(self, args, pretrained=True):
        ...
        self.road_linear = torch.nn.Sequential(
            nn.Linear(2048 * 2 * 3, 1024),#取决图片尺寸
            nn.ReLU(),
            nn.Linear(1024, args.scenes_classes))
        ...
        """场景识别分支 初始化权重"""
        initialize_weights(self.road_linear)
