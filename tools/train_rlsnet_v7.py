...
def train(args, model, optimizer, dataloader_train, dataloader_val, logger, final_output_dir):
    if args.use_ohem:
        drivable_loss = OhemCrossEntropy(ignore_label = args.ignore_label).cuda()
    else:
...
def main(params):
    ...
    parser.add_argument('--use_ohem', type=bool, default=True, help='path to save model')
...
if __name__ == '__main__':
    params = [
        ...
        '--backbone', '34',  # only support resnet50 and resnet101
