...
def train(args, model, optimizer, dataloader_train, dataloader_val):
    ...
    for epoch in range(args.num_epochs):
        ...
        for sample, scenes_id in dataloader_train:
            ...
            loss = 1.5*loss_drivable + loss_lane + 0.5*loss_scenes
...
if __name__ == '__main__':
    params = [
        ...
        '--save_model_path', '/workspace/xiaozhihao/RLSnet/checkpoint_of_XZH/(2022.10.16)RLS_resnet50_sad_quanzhong(v4)/',
        '--backbone', '50',  # only support resnet50 and resnet101
        '--optimizer', 'sgd',
        '--ignore_label', '255',
        '--note', '用的v4, sad,res50, loss权重1.5,1,0.5'
    ]
    main(params)